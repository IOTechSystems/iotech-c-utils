 ...
 *
 * An initial string buffer and size is provided. If the buffer is too small a new buffer will
 ...
 * @return       Output buffer or a new buffer if provided buffer to small
 */
