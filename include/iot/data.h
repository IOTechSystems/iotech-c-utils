...
/**
 * @brief Set next_or_meta for data
 *
 * Set next_or_meta on a data item. Meta data elements are reference counted by the associated data element.
 *
 * @param  data  Pointer to data
 * @param  metadata  Pointer to next_or_meta
 */
extern void iot_data_set_metadata (iot_data_t * data, iot_data_t * metadata);

/**
 * @brief Get next_or_meta for data
 *
 * Gets the next_or_meta associated with a data item.
 *
 * @param  data  Pointer to data
 * @return       Pointer to next_or_meta (NULL if not set)
 */
 ...
 *
 * The function to convert data to a json string. If next_or_meta has been
 * added to a map in the format generated by iot_data_from_json_with_ordering
 * then the next_or_meta string vectors will be used to determine which map entries
...
/**
 * @brief Convert json to iot_data_t type with optional object ordering next_or_meta
 *
 * The function to convert input json string to iot_data and optionally adds
 * next_or_meta to the result. The next_or_meta is associated with each map
 * representing JSON objects. The next_or_meta is in the form of a map which
...
/**
 * @brief Convert json to iot_data_t type with optional object ordering next_or_meta and shared key map
 *
 * The function to convert input json string to iot_data and optionally adds
 * next_or_meta to the result. The next_or_meta is associated with each map
 * representing JSON objects. The next_or_meta is in the form of a map which
