...
/**
 * @brief Set metadataa for data
 *
 * Set metadataa on a data item. Meta data elements are reference counted by the associated data element.
 *
 * @param  data  Pointer to data
 * @param  metadata  Pointer to metadataa
 */
extern void iot_data_set_metadata (iot_data_t * data, iot_data_t * metadata);

/**
 * @brief Get metadataa for data
 *
 * Gets the metadataa associated with a data item.
 *
 * @param  data  Pointer to data
 * @return       Pointer to metadataa (NULL if not set)
 */
 ...
 *
 * The function to convert data to a json string. If metadataa has been
 * added to a map in the format generated by iot_data_from_json_with_ordering
 * then the metadataa string vectors will be used to determine which map entries
...
/**
 * @brief Convert json to iot_data_t type with optional object ordering metadataa
 *
 * The function to convert input json string to iot_data and optionally adds
 * metadataa to the result. The metadataa is associated with each map
 * representing JSON objects. The metadataa is in the form of a map which
...
/**
 * @brief Convert json to iot_data_t type with optional object ordering metadataa and shared key map
 *
 * The function to convert input json string to iot_data and optionally adds
 * metadataa to the result. The metadataa is associated with each map
 * representing JSON objects. The metadataa is in the form of a map which
