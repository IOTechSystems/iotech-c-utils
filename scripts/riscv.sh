...
case "${TARGET}" in
  ...
  riscv64-musl-rv64i)
    ...
    RISCV=RISCV64
    RISCV_DEFS="-DRISCV_ABI=lp64 -DRISCV_ARCH=rv64i -D_YOCTO_MUSL_=True"
  ...
  riscv32-musl-rv32i)
    ...
    RISCV=RISCV32
    RISCV_DEFS="-DRISCV_ABI=ilp32 -DRISCV_ARCH=rv32i -D_YOCTO_MUSL_=True"
  ...
  riscv64-musl-rv64id)
    ...
    RISCV=RISCV64
    RISCV_DEFS="-DRISCV_ABI=lp64d -DRISCV_ARCH=rv64id -D_YOCTO_MUSL_=True"
  ...
  riscv32-musl-rv32id)
    ...
    RISCV=RISCV32
    RISCV_DEFS="-DRISCV_ABI=ilp32d -DRISCV_ARCH=rv32id -D_YOCTO_MUSL_=True"
