...
int main (void)
{
  iot_logger_t * plogger = iot_logger_alloc ("Scheduler", IOT_LOG_WARN, 1);
  iot_logger_t * slogger = iot_logger_alloc ("ThreadPool", IOT_LOG_WARN, 1);
  iot_logger_t * mlogger = iot_logger_alloc ("main", IOT_LOG_INFO, 1);
