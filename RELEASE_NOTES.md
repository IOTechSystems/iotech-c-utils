...
- Added functions `iot_data_map_get_i32`, `iot_data_map_get_u32`, `iot_data_string_map_get_i64` and `iot_data_string_map_get_u64` to get typed integer values from a map